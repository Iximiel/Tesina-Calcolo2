...
\begin{axis}[axis x line = center, axis y line = center, ylabel=v, ylabel style={left}, xlabel=E, xlabel style={below right}, xmin = 0, xmax = 210, ymin=-0.1,ymax =7]

	\addplot[domain=5:205, samples =501, orange]	plot[id=provaV]	function{sqrt(2*x/\m)};
