...
\lr\{.{\begin{array}{l}
	...
	%T = \frac{\lrt{k_1^2-k_2^2}^2\sin^2\lrt{(a k_2)}}{4 k_1^2 k_2^2 \cos^2\lrt{a k_2}+\lrt{k_1^2+k_2^2}^2\sin^2\lrt{a k_2}}
	\end{array}}
\end{equation}
...
\begin{figure}[hbt]
	...
	\addplot table[x=ev,y=L2] {Dati/pesiOscg1.tdt};%{Dati/Salto.tdt};
	\addlegendentry{$a=2$, $\sigma=0.5$}
	\addplot table[x=ev,y=L2] {Dati/pesiOscg2.tdt};
	\addlegendentry{$a=2$, $\sigma=1$}
	\addplot table[x=ev,y=L2] {Dati/pesiOscg3.tdt};
	\addlegendentry{$a=2$, $\sigma=2$}
	\addplot table[x=ev,y=L2] {Dati/pesiOscg4.tdt};
